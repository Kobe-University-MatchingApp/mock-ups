        ...
        <div className="bg-white rounded-2xl shadow-xl p-8 md:p-12">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mt-8">
            ...
            >
              ...
              <span className="text-sm mt-1 opacity-90">ログイン画面</span>
            </Link>
            ...
            >
              ...
              <span className="text-sm mt-1 opacity-90">プロフィール画面</span>
            </Link>
            ...
            >
              ...
              <span className="text-xl font-semibold">Matching</span>
              <span className="text-sm mt-1 opacity-90">マッチング画面</span>
            </Link>
            ...
            >
              ...
              <span className="text-sm mt-1 opacity-90">チャット画面</span>
            </Link>
          </div>
